    ...
    private LinkedList<State> generateSuccessors(State currState) {
        ...
        for(int y = 0; y < 3; y++) {
            for (int x = 0; x < 3; x++) {
                ...
                if (x == 1 && y == 0) {
                    newState = new State(new Cood(currState.getCurrCood().getX()+x-1, currState.getCurrCood().getY()+y+1), currState, currState.getGx(), 0, false);
                    ...
                    newState = new State(new Cood(currState.getCurrCood().getX()+x-1, currState.getCurrCood().getY()+y-3), currState, currState.getGx(), 0, false);
                    System.out.println("Created successor: (" + newState.getCurrCood().getX() + "," + newState.getCurrCood().getY() + ")");
                    System.out.println("Successor has tile " + map.get(newState.getCurrCood()));
                    System.out.println("The view coordinates are: [" + y + "][" + x + "]");
                    successorQueue.add(newState);
